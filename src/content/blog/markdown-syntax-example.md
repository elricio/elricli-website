---
title: 'Markdown 语法示例'
description: '展示 Markdown 语法的基本使用方法，包括标题、字体、列表、任务列表、引用等。'
pubDate: 2020-07-15
tags: ['Markdown']
---
...
**本文包含部分微信平台特殊语法** [[MarkDown语法|标准Markdown语法快捷说明请查看这里]]
...
任务列表的使用，在符号`- [ ]`后加空格后输入内容，`- [x]`后加空格后输入内容标记已完成，如下：
...
[全栈工程师](https://baike.baidu.com/item/全栈工程师 '什么是全栈工程师')在业务开发流程中起到了至关重要的作用。
...
[在线 markdown 编辑器\_微信公众号 markdown 排版工具](https://markdown.com.cn/editor/)
